...
enum states
{
  FINISHED, MSG_RECEIVING, FILE_PROCESSING,HEADER_SENDING, ERROR_HEADER_SENDING,
  FILE_SENDING, ERROR_SENDING, MSG_RECEIVED, HEADER_SENT, ERROR_HEADER_SENT,
  FILE_SENT, ERROR_SENT
};
